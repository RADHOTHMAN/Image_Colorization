...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Sending colorization request to Lovable AI");
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Colorize this grayscale image with realistic, natural colors. Make it look vibrant and professionally colored. Return only the colorized image.",
              },
              {
                type: "image_url",
                image_url: {
